<?php
return array (
  'ADMIN_CAIJI_INDEX' => '斗图啦',
  'ADMIN_CAIJI_INDEXS' => '表情包采集',
  'ADMIN_CAIJI_ZUIHUO' => 'hotemoji采集',
  'ADMIN_EMOJI_AD' => '广告位 ',
  'ADMIN_EMOJI_CEMOJI' => '表情管理',
  'ADMIN_EMOJI_FULI' => '福利',
  'ADMIN_EMOJI_GETCAT' => '分类管理',
  'ADMIN_EMOJI_INDEX' => '小程序',
  'ADMIN_EMOJI_NAV' => '导航管理',
  ...
  'USER_ADMININDEX_DEFAULT' => '用户-订单管理',
  'USER_ADMININDEX_DEFAULT1' => '用户+订单',
  'USER_ADMININDEX_INDEX' => '本站用户',
  'USER_ADMINOAUTH_DELETE' => '删除第三方用户绑定',
  'USER_ADMINOAUTH_DINGDAN' => '小程序订单',
